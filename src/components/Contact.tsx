  ...
  return (
    <section id="contact" className="py-16 md:py-32 bg-gray-100">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-8 text-gray-800 text-center">Contact Me</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <form>
                ...
                <button type="submit" className="bg-orange-500 text-white py-2 px-4 rounded-md hover:bg-red-700 transition duration-300">
                  Send Message
                </button>
              </form>
            </div>
