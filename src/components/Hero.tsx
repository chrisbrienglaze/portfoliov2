...
<p> I am skilled in all stages of the software development life cycle, from design to deployment, using technologies like HTML, CSS, JavaScript, React, and Node.js. I'm also committed to staying current with new technologies and web development trends.</p>
          ...
          <div className="flex gap-4 pt-4">
            ...
            <button className="border-2 border-gray-800 text-gray-800 px-6 py-3 rounded-lg hover:bg-gray-100 transition flex items-center gap-2" onClick={onDownloadCVClick}>
              Download CV
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
